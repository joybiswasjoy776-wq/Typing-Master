...
class TypingTest {
    constructor() {
        this.quotes = {
            easy: [
                "The sun rises every morning and gives us light and warmth. Birds sing in the trees, and people start their daily work.",
                 "Some go to school, while others go to the office.",
                 "A healthy breakfast gives us energy for the day.",
                 "Being kind to others and helping people can make the world a better place.",
                 "Every day is a new chance to learn something useful.",
            ],

            medium: [
                "Technology has changed the way we communicate, learn, and work.",
                " People can now connect with friends and family from different parts of the world in just a few seconds.",
                "  While modern devices make life easier, it is also important to spend time away from screens. Reading books, exercising regularly, and enjoying nature can improve both physical and mental health.",
                " A balanced lifestyle leads to greater happiness and productivity.",
            ],
